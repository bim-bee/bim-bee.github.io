(function initNcNestingI18n() {
  ...
  const en = {
    ...
    "action.continueGreedy": "Continue with greedy solution",
    ...
    "action.openGreedyCutPlan": "Open greedy cut plan (DEV)",
    ...
    "input.groupComplexityExceeded": "{count} nesting groups detected; combined optimization difficulty is high",
    ...
    "input.fixHighlightedPanels": "Correct the errors shown in the relevant input panels.",
    ...
    "batch.greedyFallbackNotice": "Some nesting groups use a local greedy solution because backend optimization was unavailable.",
    "batch.demoMessage": "This is the demo example. Open the cutting plan to check the layout.",
    ...
    "optimization.greedyBaseline": "Greedy baseline",
    "plan.greedyComparisonLabel": "Greedy baseline (DEV)",
    "plan.greedyComparisonHeading": "Greedy comparison view",
    "plan.greedyComparisonTitle": "Original frontend greedy cut plan",
    "plan.greedyComparisonDetail": "This is the stored greedy baseline reconstructed from the exact same nesting-group inputs, stock options, storage stock and cutting settings. Use it only for development comparison with the optimized result.",
    "optimization.optimizedResult": "Optimized result",
    "optimization.savedVsGreedy": "Saved vs. greedy",
    "optimization.improvement": "Improvement",
    "optimization.provenOptimum": "Proven optimum",
    "optimization.bestProvenBound": "Best proven bound",
    ...
    "optimization.bestKnownLimit": "A complete validated cutting plan was returned. Further optimization stopped at the available calculation limit.",
    "optimization.failed": "Failed",
    "optimization.orderedStock": "ordered stock pieces",
    "optimization.totalStockLength": "total stock length",
    "optimization.reusableOffcutLength": "reusable offcut length",
    "optimization.reusableOffcutCount": "reusable offcuts",
    "optimization.matchesGreedy": "Matches greedy baseline",
    "optimization.greedyOnly": "Greedy only",
    "optimization.greedySolution": "Greedy solution",
    "optimization.backendUnavailableForResult": "Backend optimization was not available for this result.",
    "optimization.message.optimalHeadline": "Best possible solution proven.",
    "optimization.message.bestKnownHeadline": "Further improvement may still be possible.",
    "optimization.message.greedyOnlyHeadline": "No optimization attempt.",
    "optimization.message.failedHeadline": "No usable result was returned.",
    "optimization.message.optimalGreedyAlreadyBest": "The initial greedy solution was proven to already be the best possible solution.",
    "optimization.message.optimalImprovedOrderedOne": "The best solution uses 1 fewer ordered stock piece than the initial greedy attempt.",
    "optimization.message.optimalImprovedOrderedMany": "The best solution uses {count} fewer ordered stock pieces than the initial greedy attempt.",
    "optimization.message.optimalImprovedTotalLength": "The best solution uses {length} less total stock length than the initial greedy attempt.",
    "optimization.message.optimalImprovedReusableLength": "The best solution creates {length} more reusable stock length than the initial greedy attempt.",
    "optimization.message.optimalImprovedReusableCountOne": "The best solution keeps the same reusable stock length in 1 fewer reusable offcut than the initial greedy attempt.",
    "optimization.message.optimalImprovedReusableCountMany": "The best solution keeps the same reusable stock length in {count} fewer reusable offcuts than the initial greedy attempt.",
    "optimization.message.bestKnownImprovedOrderedOne": "A better solution was found that uses 1 fewer ordered stock piece than the initial greedy attempt.",
    "optimization.message.bestKnownImprovedOrderedMany": "A better solution was found that uses {count} fewer ordered stock pieces than the initial greedy attempt.",
    "optimization.message.bestKnownImprovedTotalLength": "A better solution was found that uses {length} less total stock length than the initial greedy attempt.",
    "optimization.message.bestKnownImprovedReusableLength": "A better solution was found that creates {length} more reusable stock length than the initial greedy attempt.",
    "optimization.message.bestKnownImprovedReusableCountOne": "A better solution was found that keeps the same reusable stock length in 1 fewer reusable offcut than the initial greedy attempt.",
    "optimization.message.bestKnownImprovedReusableCountMany": "A better solution was found that keeps the same reusable stock length in {count} fewer reusable offcuts than the initial greedy attempt.",
    "optimization.message.bestKnownGreedyTime": "Not enough calculation time to prove a better plan exists than the greedy solution.",
    "optimization.message.bestKnownGreedyStopped": "The greedy solution is being used. It was not proven to be the best, and no improvement was found for this nesting group.",
    "optimization.message.optimalGeneric": "The returned cutting plan was proven to be the best possible solution.",
    "optimization.message.bestKnownGenericTime": "A complete cutting plan was returned, but there was not enough calculation time to prove whether it can be improved.",
    "optimization.message.bestKnownGeneric": "A complete cutting plan was returned, but it was not proven to be the best possible solution.",
    "optimization.message.greedyOnlyDetail": "This nesting group is using the initial greedy solution.",
    "optimization.message.failedDetail": "A valid cutting plan could not be produced for this nesting group.",
    ...
    "plan.pieceDescription": "Parts {partLength}; consumed {consumed}; offcut {offcut} ({status}).",
    ...
    "preflight.groupTooLarge": "Expected calculation difficulty is very high.",
    "preflight.batchTooComplex": "Combined optimization difficulty is high.",
    "preflight.tooManyGroups": "Too many nesting groups were detected for one solve. Maximum: {max}.",
    ...
    "error.serviceStoppedResponding": "The calculation service stopped responding.",
    "fallback.greedyExplanation": "You can still continue using the local greedy cutting solution. This result has not been optimized or validated by the calculation service.",
    ...
    "error.greedyPlanUnavailable": "The stored greedy baseline cannot be reconstructed for this cutting plan.",
    ...
    "planError.devDetails": "DEV validation details — exact piece data",
  ...
  const he = {
    ...
    "action.close": "סגירה",
    "action.cancel": "ביטול",
    "action.continueGreedy": "המשך עם אלגוריתם חמדן",
    ...
    "action.openGreedyCutPlan": "פתיחת תכנית חיתוך חמדנית (DEV)",
    ...
    "input.groupComplexityExceeded": "זוהו {count} קבוצות חיתוך; מורכבות האופטימיזציה המשולבת גבוהה",
    ...
    "input.fixHighlightedPanels": "יש לתקן את השגיאות המוצגות בלוחות הקלט הרלוונטיים.",
    ...
    "batch.greedyFallbackNotice": "חלק מקבוצות החיתוך משתמשות באלגוריתם חמדן מקומי משום שאופטימיזציית שירות החישוב לא הייתה זמינה.",
    "batch.demoMessage": "זוהי דוגמת ההדגמה. אפשר לפתוח את תכנית החיתוך ולבדוק את הפריסה.",
    ...
    "optimization.comparison": "השוואת אופטימיזציה",
    "optimization.greedyBaseline": "אלגוריתם חמדן",
    "plan.greedyComparisonLabel": "פתרון חמדני (DEV)",
    "plan.greedyComparisonHeading": "תצוגת השוואה לפתרון החמדני",
    "plan.greedyComparisonTitle": "תכנית החיתוך החמדנית המקורית של ה-Frontend",
    "plan.greedyComparisonDetail": "זהו הפתרון החמדני השמור, ששוחזר מאותם נתוני קבוצת חיתוך, אפשרויות מוטות, מלאי והגדרות חיתוך בדיוק. התצוגה מיועדת להשוואת פיתוח מול התוצאה שעברה אופטימיזציה.",
    "optimization.optimizedResult": "תוצאה ממוטבת",
    "optimization.savedVsGreedy": "חיסכון מול אלגוריתם חמדן",
    "optimization.improvement": "שיפור",
    "optimization.provenOptimum": "אופטימום מוכח",
    "optimization.bestProvenBound": "החסם המוכח הטוב ביותר",
    ...
    "optimization.bestKnownLimit": "התקבלה תוכנית חיתוך מלאה ומאומתת. אופטימיזציה נוספת הופסקה במגבלת החישוב הזמינה.",
    "optimization.failed": "נכשל",
    "optimization.orderedStock": "מוטות להזמנה",
    "optimization.totalStockLength": "אורך מוטות כולל",
    "optimization.reusableOffcutLength": "אורך שארית שמישה",
    "optimization.reusableOffcutCount": "שאריות שמישות",
    "optimization.matchesGreedy": "זהה לאלגוריתם חמדן",
    "optimization.greedyOnly": "אלגוריתם חמדן בלבד",
    "optimization.greedySolution": "אלגוריתם חמדן",
    "optimization.backendUnavailableForResult": "אופטימיזציית שירות החישוב לא הייתה זמינה עבור תוצאה זו.",
    "optimization.message.optimalHeadline": "הוכח שזה הפתרון הטוב ביותר האפשרי.",
    "optimization.message.bestKnownHeadline": "ייתכן שעדיין אפשר לשפר את הפתרון.",
    "optimization.message.greedyOnlyHeadline": "לא בוצע ניסיון אופטימיזציה.",
    "optimization.message.failedHeadline": "לא התקבלה תוצאה שניתן להשתמש בה.",
    "optimization.message.optimalGreedyAlreadyBest": "הפתרון שהתקבל עם אלגוריתם חמדן הוכח כפתרון הטוב ביותר האפשרי.",
    "optimization.message.optimalImprovedOrderedOne": "הפתרון הטוב ביותר מפחית את מספר המוטות להזמנה ב־1 לעומת אלגוריתם חמדן.",
    "optimization.message.optimalImprovedOrderedMany": "הפתרון הטוב ביותר מפחית את מספר המוטות להזמנה ב־{count} לעומת אלגוריתם חמדן.",
    "optimization.message.optimalImprovedTotalLength": "הפתרון הטוב ביותר מפחית את אורך המוטות הכולל ב־{length} לעומת השימוש באלגוריתם חמדן.",
     "optimization.message.optimalImprovedReusableLength": "הסידור הזה טוב יותר מהפתרון שהתקבל באמצעות אלגוריתם חמדן. {length} יותר חומר שמיש שניתן להחזיר למלאי עבור אותו ניצולת ופחת.",
    "optimization.message.optimalImprovedReusableCountOne": "הפתרון הטוב ביותר שומר על אותו אורך חומר שמיש עם שארית שמישה אחת פחות לעומת אלגוריתם חמדן.",
    "optimization.message.optimalImprovedReusableCountMany": "הפתרון הטוב ביותר שומר על אותו אורך חומר שמיש עם {count} פחות שאריות שמישות לעומת אלגוריתם חמדן.",
    "optimization.message.bestKnownImprovedOrderedOne": "נמצא פתרון טוב יותר שמפחית את מספר המוטות להזמנה ב־1 לעומת אלגוריתם חמדן.",
    "optimization.message.bestKnownImprovedOrderedMany": "נמצא פתרון טוב יותר שמפחית את מספר המוטות להזמנה ב־{count} לעומת אלגוריתם חמדן.",
    "optimization.message.bestKnownImprovedTotalLength": "נמצא פתרון טוב יותר שמפחית את אורך המוטות הכולל ב־{length} לעומת אלגוריתם חמדן.",
    "optimization.message.bestKnownImprovedReusableLength": "נמצא פתרון טוב יותר שמשאיר {length} יותר חומר שמיש לשימוש חוזר לעומת אלגוריתם חמדן.",
    "optimization.message.bestKnownImprovedReusableCountOne": "נמצא פתרון טוב יותר ששומר על אותו אורך חומר שמיש עם שארית שמישה אחת פחות לעומת אלגוריתם חמדן.",
    "optimization.message.bestKnownImprovedReusableCountMany": "נמצא פתרון טוב יותר ששומר על אותו אורך חומר שמיש עם {count} פחות שאריות שמישות לעומת אלגוריתם חמדן.",
    "optimization.message.bestKnownGreedyTime": "לא היה מספיק זמן חישוב כדי להוכיח אם קיים פתרון טוב יותר משהתקבל באלגוריתם חמדן.",
    "optimization.message.bestKnownGreedyStopped": "לא היה מספיק זמן חישוב כדי לנסות להוכיח אם קיים פתרון טוב יותר משהתקבל באלגוריתם חמדן.",
    "optimization.message.optimalGeneric": "הוכח שתוכנית החיתוך שהתקבלה היא הפתרון הטוב ביותר האפשרי.",
    "optimization.message.bestKnownGenericTime": "לא היה מספיק זמן חישוב כדי לנסות להוכיח אם קיים פתרון טוב יותר משהתקבל באלגוריתם חמדן.",
    "optimization.message.bestKnownGeneric": "התקבלה תוכנית חיתוך מלאה, אך לא הוכח שהיא הפתרון הטוב ביותר האפשרי.",
    "optimization.message.greedyOnlyDetail": "קבוצת החיתוך הזאת משתמשת באלגוריתם חמדן.",
    "optimization.message.failedDetail": "לא ניתן היה להפיק תוכנית חיתוך תקינה לקבוצת החיתוך הזאת.",
    ...
    "plan.pieceDescription": "חלקים {partLength}; אורך מנוצל {consumed}; שארית {offcut} ({status}).",
    ...
    "preflight.groupTooLarge": "מורכבות החישוב הצפויה גבוהה מאוד.",
    "preflight.batchTooComplex": "מורכבות האופטימיזציה המשולבת גבוהה.",
    "preflight.tooManyGroups": "זוהו יותר מדי קבוצות חיתוך לפעולת חישוב אחת. מקסימום: {max}.",
    ...
    "error.serviceStoppedResponding": "שירות החישוב הפסיק להגיב.",
    "fallback.greedyExplanation": "ניתן להמשיך באמצעות אלגוריתם חמדן מקומי לחיתוך. תוצאה זו לא עברה אופטימיזציה או אימות על ידי שירות החישוב.",
    ...
    "error.greedyPlanUnavailable": "לא ניתן לשחזר את הפתרון החמדני השמור עבור תכנית החיתוך הזאת.",
    ...
    "planError.devDetails": "פרטי אימות DEV — הנתונים המדויקים של המוט",
