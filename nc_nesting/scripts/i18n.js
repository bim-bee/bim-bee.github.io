(function initNcNestingI18n() {
  ...
  const en = {
    ...
    "common.individualStockPieces": "Individual stock pieces",
    ...
    "page.stocksMatrix": "Stocks matrix — parts per layout",
    ...
    "input.selectNc": "or click to select a batch of .nc1 files",
    ...
    "input.stockExplanation": "Profile is required. Steel grade is optional: a blank value matches every grade of that profile. Blank IDs receive stable defaults such as Order-A and Order-B.",
    "input.storageExplanation": "Only storage stocks that exactly match a nesting group and can fit at least one requested part are grouped for solving. Blank IDs receive stable defaults such as Storage-A and Storage-B. Storage-area details remain in the browser project and are not sent for calculation.",
    ...
    "batch.consumedLength": "{length} consumed",
    ...
    "plan.includesParts": "{length} including parts, trims and tool cuts",
  ...
  const he = {
    ...
    "common.individualStockPieces": "מוטות בודדים",
    ...
    "common.reusableOffcut": "שארית להחזרה למלאי",
    "common.reusableLeftover": "שארית להחזרה למלאי",
    "common.nonReusableOffcut": "פסולת",
    "common.nonReusableWaste": "פסולת",
    "common.reusableReturned": "שארית להחזרה למלאי",
    "common.reusableReturnedToStorage": "שארית להחזרה למלאי",
    ...
    "page.stocksMatrix": "פריסת מוטות לחיתוך במטריצה",
    ...
    "input.selectNc": "או לחצו להעלאת מספר קובצי ‎.nc1",
    ...
    "input.stockExplanation": "חובה להזין פרופיל. דרגת הפלדה אופציונלית: שדה ריק יתאים לכל דרגת פלדה של אותו פרופיל. למזהים ריקים יוקצו מזהים קבועים כגון Order-A ו־Order-B.",
    "input.storageExplanation": "לחישוב ייכללו מהמלאי רק מוטות המתאימים בדיוק לקבוצת חיתוך כלשהי עבור אורך חלק נדרש אחד לפחות. למזהים ריקים יוקצו מזהים קבועים כגון Storage-A ו־Storage-B.",
    ...
    "batch.consumedLength": "אורך מנוצל {length}",
    ...
    "plan.includesParts": "{length} כולל חלקים, חיתוכי קצה וחיתוכי מסור",
    "plan.totalOffcutNote": "{length} סה״כ שאריות",
    "plan.consumedStorageNote": "{length} נוצל מהמלאי",
    "plan.reusableNote": "{length} שארית להחזרה למלאי",
    "plan.cutLabel": "חיתוך",
